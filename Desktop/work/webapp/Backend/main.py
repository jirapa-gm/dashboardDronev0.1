...
RAW_EVENTS = [
    # GA / SG_A1 / A1-001
    {
        "id": "EVT-A1-001-1", "datetime": "2026-04-03T10:00:00",
        "group": "GA", "subgroup": "SG_A1",
        "detector_id": "A1-001", "detector_name": "Detector_A1_001",
        "detector_lat": 13.7569, "detector_lon": 100.5915,
        "drone_id": "DR-3299", "model": "DJI Air 3",
        "latitude": 13.7569, "longitude": 100.5915,
        "height": 28, "speed": 2.68, "freq": 2450,
    ...
    {
        "id": "EVT-A1-001-2", "datetime": "2026-04-03T12:00:00",
        "group": "GA", "subgroup": "SG_A1",
        "detector_id": "A1-001", "detector_name": "Detector_A1_001",
        "detector_lat": 13.7569, "detector_lon": 100.5915,
        "drone_id": "DR-5697", "model": "DJI Mini 3",
        "latitude": 13.7653, "longitude": 100.5975,
        "height": 40, "speed": 0.52, "freq": 2400,
        "has_gps": False, "pilot_lat": None, "pilot_lng": None,
        "aoa_degrees": 125.5, "rssi_dbm": -74, "snr_db": 12.1,
        "protocol_name": "DIY/FPV", "registered": False,
    },
    # GA / SG_A1 / A1-002
    {
        "id": "EVT-A1-002-1", "datetime": "2026-04-02T11:20:00",
        "group": "GA", "subgroup": "SG_A1",
        ...
        "latitude": 13.7142, "longitude": 100.5159,
        "height": 49, "speed": 2.01, "freq": 2500,
    ...
    # GA / SG_A2 / A2-001
    {
        "id": "EVT-A2-001-1", "datetime": "2026-04-02T09:00:00",
        ...
        "latitude": 13.7845, "longitude": 100.5059,
        "height": 12, "speed": 4.62, "freq": 2400,
        "has_gps": True, "pilot_lat": 13.7860, "pilot_lng": 100.5040,
        "aoa_degrees": None, "rssi_dbm": -50, "snr_db": 28.3,
        "protocol_name": "DJI OcuSync", "registered": True,
    },
    {
        "id": "EVT-A2-001-2", "datetime": "2026-04-06T16:45:00",
        "group": "GA", "subgroup": "SG_A2",
        "detector_id": "A2-001", "detector_name": "Detector_A2_001",
        "detector_lat": 13.7845, "detector_lon": 100.5059,
        "drone_id": "DR-2011", "model": "DJI Mini 3",
        "latitude": 13.7357, "longitude": 100.5884,
        "height": 71, "speed": 1.81, "freq": 2500,
        "has_gps": False, "pilot_lat": None, "pilot_lng": None,
        "aoa_degrees": 210.0, "rssi_dbm": -79, "snr_db": 9.8,
        "protocol_name": "Unknown", "registered": False,
    },
    # GB / SG_B1 / B1-001
    {
        "id": "EVT-B1-001-1", "datetime": "2026-04-02T14:00:00",
        ...
        "latitude": 13.7425, "longitude": 100.5512,
        "height": 55, "speed": 6.21, "freq": 2400,
    ...
    {
        "id": "EVT-B1-001-2", "datetime": "2026-04-02T15:30:00",
        "group": "GB", "subgroup": "SG_B1",
        "detector_id": "B1-001", "detector_name": "Detector_B1_001",
        "detector_lat": 13.7425, "detector_lon": 100.5512,
        "drone_id": "DR-8822", "model": "DJI Mini 3",
        "latitude": 13.7511, "longitude": 100.5321,
        "height": 35, "speed": 3.12, "freq": 2450,
        "has_gps": True, "pilot_lat": 13.7490, "pilot_lng": 100.5300,
        "aoa_degrees": None, "rssi_dbm": -66, "snr_db": 17.8,
        "protocol_name": "DJI OcuSync", "registered": True,
    },
    # GB / SG_B2 / B2-001
    {
        "id": "EVT-B2-001-1", "datetime": "2026-04-03T11:00:00",
        ...
        "latitude": 13.7312, "longitude": 100.5646,
        "height": 67, "speed": 4.23, "freq": 2450,
        "has_gps": True, "pilot_lat": 13.7285, "pilot_lng": 100.5620,
        "aoa_degrees": None, "rssi_dbm": -70, "snr_db": 16.3,
        "protocol_name": "DJI OcuSync", "registered": False,
    },
    {
        "id": "EVT-B2-002-1", "datetime": "2026-04-05T08:20:00",
        "group": "GB", "subgroup": "SG_B2",
        "detector_id": "B2-002", "detector_name": "Detector_B2_002",
        "detector_lat": 13.7450, "detector_lon": 100.5200,
        "drone_id": "DR-9112", "model": "DJI Mini 3",
        "latitude": 13.7450, "longitude": 100.5200,
        "height": 38, "speed": 1.95, "freq": 2400,
        "has_gps": True, "pilot_lat": 13.7430, "pilot_lng": 100.5185,
        "aoa_degrees": None, "rssi_dbm": -48, "snr_db": 30.1,
        "protocol_name": "DJI OcuSync", "registered": True,
    },
]
...
def compute_frequency_distribution(events: list) -> list:
    ...
    bands = {"2400-2429 MHz": 0, "2430-2459 MHz": 0, "2460-2500 MHz": 0}
    for e in events:
